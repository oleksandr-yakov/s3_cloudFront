...
class PipelineStackFront(Stack):
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        source_action = codepipeline_actions.CodeStarConnectionsSourceAction(
            ...
            branch=branch,   # use global env var : DEV_ENV=dev && cdl deploy <name stack> --profile oyakovenko-trainee
            action_name='GitHub_Source_ovsrd-trainee-front',
            ...
            project=codebuild.PipelineProject(self, "MyBuildProject",
                                              build_spec=codebuild.BuildSpec.from_object({
                                                  ...
                                                  "phases": {
                                                      "build": {
                                                          "commands": [
                                                              f"echo test ovsrd-trainee-front {branch}",
                                                          ],
                                                      },
                                                  },
                                                  # "artifacts": {
        ...
        pipeline = codepipeline.Pipeline(self, "FrontPipeline", stages=[
